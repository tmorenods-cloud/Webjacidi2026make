import svgPaths from "./svg-sbjirhb8np";
import imgRectangle2355 from "./9249e5057a24c153b07287f7f65477c6e06a63c5.png";
import imgRectangle2356 from "./16008f0c2e2e2d416662c6c799ad4af5f3923d56.png";
import imgRectangle2357 from "./981c9c26263fa05ad949448589abfc5a51eec775.png";
import imgCaseStudyImage from "./695b352afdca68e345698611f5c1cf7c0ca8ca6a.png";
import imgCaseStudyImage1 from "./a5c29d5aa98abcf3f657c27901d2abbe55dec97c.png";
import imgCaseStudyImage2 from "./e1d6367c35e99575cef39b4ce722be78da6770be.png";
import imgCaseStudyImage3 from "./0a2e79bcd47a4aacb95357549ff5939bc54d20c9.png";
import imgCaseStudyImage4 from "./c0277f15dd06af820ab8d7faefbd135cf318a958.png";
import imgCaseStudyImage5 from "./9424d751efc36ee0a920f89ac42d391784837c2a.png";

function CaseStudyDateBadge() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(32,32,31,0.7)] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[6px] shrink-0" data-name="Case Study Date Badge">
...
function CaseStudyImage() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start p-[20px] relative size-full">
          <div className="absolute h-[560px] left-0 top-0 w-[747px]">
            <div aria-hidden className="absolute inset-0 pointer-events-none">
              <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.529deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
              <img alt="" className="absolute max-w-none object-cover size-full" src={imgRectangle2355} />
            </div>
          </div>
          <CaseStudyDateBadge />
        </div>
...
function Frame1() {
  return (
    <div className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[32px] leading-[normal] not-italic relative shrink-0 text-[#909090] text-[18px] tracking-[-0.36px] w-[239px] whitespace-nowrap">
      <p className="absolute left-0 opacity-0 top-[3px]">Marketing 360, UX/UI, Brand</p>
      <p className="absolute left-0 top-[39px]">Marketing 360, UX/UI, Brand</p>
    </div>
  );
}

function CaseStudyLinkArrow() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Case Study Link Arrow">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_40_340)" id="Case Study Link Arrow">
          <path d={svgPaths.p14423000} fill="var(--fill-0, #20201F)" id="Vector" />
          <path d={svgPaths.pe7e6400} fill="var(--fill-0, #20201F)" id="Vector_2" />
        </g>
        <defs>
...
function CaseStudyInfo() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Case Study Info">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#20201f] text-[24px] tracking-[-0.48px] whitespace-nowrap">navicu.com</p>
      <Container />
    </div>
  );
}

function CaseStudyDateBadge1() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(32,32,31,0.7)] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[6px] shrink-0" data-name="Case Study Date Badge">
      <div aria-hidden className="absolute border border-[rgba(32,32,31,0.2)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[18px] text-white tracking-[-0.36px] whitespace-nowrap">2025</p>
...
function CaseStudyImage1() {
  return (
    <div className="content-stretch flex gap-[10px] h-[372px] items-start overflow-clip p-[20px] relative shrink-0 w-[495px]" data-name="Case Study Image">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[371px] left-1/2 top-[calc(50%-0.5px)] w-[495px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.534deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgRectangle2356} />
        </div>
      </div>
      <CaseStudyDateBadge1 />
    </div>
...
function LabelContainer() {
  return (
    <div className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[32px] leading-[normal] not-italic relative shrink-0 text-[#777] text-[14px] tracking-[-0.28px] w-[190px] whitespace-nowrap" data-name="label container">
      <p className="absolute left-0 opacity-0 top-[8px]">Marketing 360, UX/UI, Brand</p>
      <p className="absolute left-0 top-[44px]">Marketing 360, UX/UI, Brand</p>
    </div>
  );
}

function CaseStudyLinkArrow1() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Case Study Link Arrow">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_40_348)" id="Case Study Link Arrow">
          <path d={svgPaths.p128da600} fill="var(--fill-0, #20201F)" id="Vector" />
          <path d={svgPaths.p17ea7680} fill="var(--fill-0, #20201F)" id="Vector_2" />
        </g>
        <defs>
...
function CaseStudyInfo1() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Case Study Info">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#20201f] text-[24px] tracking-[-0.48px] whitespace-nowrap">Grand Hyatt</p>
      <Frame3 />
    </div>
  );
}

function CaseStudyDateBadge2() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(32,32,31,0.7)] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[6px] shrink-0" data-name="Case Study Date Badge">
      <div aria-hidden className="absolute border border-[rgba(32,32,31,0.2)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[18px] text-white tracking-[-0.36px] whitespace-nowrap">2025</p>
...
function CaseStudyImage2() {
  return (
    <div className="content-stretch flex gap-[10px] h-[372px] items-start overflow-clip p-[20px] relative shrink-0 w-[495px]" data-name="Case Study Image">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[371px] left-1/2 top-[calc(50%-0.5px)] w-[495px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#7edfea] inset-0" />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgRectangle2357} />
        </div>
      </div>
      <CaseStudyDateBadge2 />
    </div>
...
function CaseStudyInfo2() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Case Study Info">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#20201f] text-[24px] tracking-[-0.48px] whitespace-nowrap">Morrocoy</p>
      <Frame4 />
    </div>
  );
}
...
function CaseStudiesRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Case Studies Row">
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip relative shrink-0 w-[747px]" data-name="Case Study">
        <CaseStudyImage />
        <CaseStudyInfo />
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip relative shrink-0" data-name="Case Study">
        <CaseStudyImage1 />
        <CaseStudyInfo1 />
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip relative shrink-0" data-name="Case Study">
...
function CaseStudyImage3() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgCaseStudyImage} />
      </div>
...
function CaseStudyInfo3() {
  return (
    <div className="[word-break:break-word] content-stretch flex items-end justify-between leading-[normal] not-italic relative shrink-0 text-[#20201f] w-full whitespace-nowrap" data-name="Case Study Info">
...
function CaseStudy() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-w-px relative" data-name="Case Study">
      <CaseStudyImage3 />
      <CaseStudyInfo3 />
    </div>
  );
...
function CaseStudyImage4() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgCaseStudyImage1} />
      </div>
      <div className="content-stretch flex items-start p-[20px] relative size-full">
        <CaseStudyDateBadge4 />
      </div>
...
function CaseStudyImage5() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute h-[155.53%] left-[-17.5%] max-w-none top-[-0.05%] w-[138.74%]" src={imgCaseStudyImage2} />
        </div>
      </div>
      <div className="content-stretch flex items-start p-[20px] relative size-full">
        <CaseStudyDateBadge5 />
...
function CaseStudyImage6() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgCaseStudyImage3} />
      </div>
      <div className="content-stretch flex items-start p-[20px] relative size-full">
        <CaseStudyDateBadge6 />
      </div>
...
function CaseStudyImage7() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgCaseStudyImage4} />
      </div>
      <div className="content-stretch flex items-start p-[20px] relative size-full">
        <CaseStudyDateBadge7 />
      </div>
...
function CaseStudyImage8() {
  return (
    <div className="aspect-[442.33331298828125/331.7499694824219] relative shrink-0 w-full" data-name="Case Study Image">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(117.519deg, rgb(195, 198, 200) 12.721%, rgb(231, 234, 237) 46.826%, rgb(193, 197, 199) 106.37%)" }} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgCaseStudyImage5} />
      </div>
      <div className="content-stretch flex items-start p-[20px] relative size-full">
        <CaseStudyDateBadge8 />
      </div>
...
function CaseStudiesContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[110px] items-start left-0 px-[80px] py-[32px] top-[379px] w-[1920px]" data-name="Case Studies Container">
      <CaseStudiesRow />
      <CaseStudiesRow1 />
      <CaseStudiesRow2 />
    </div>
...
function SectionContact() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-0 p-[80px] top-[2267px] w-[1920px]" data-name="Section - Contact">
      <Row2 />
      <Row3 />
    </div>
  );
...
function NavItemContainer1() {
  return (
    <button className="bg-[#20201f] content-stretch cursor-pointer flex items-center justify-center px-[16px] py-[8px] relative rounded-[29px] shrink-0" data-name="Nav Item Container">
...
function NavigationContainer1() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="Navigation Container">
      <Frame2 />
      <NavItemContainer1 />
    </div>
  );
...
export default function Proyectos() {
  return (
    <div className="bg-white relative size-full" data-name="Proyectos">
      <CaseStudiesContainer />
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[0.83] left-[80px] not-italic text-[#20201f] text-[72px] top-[239px] tracking-[-3.6px] w-[459px]">Nuestros casos de éxito</p>
      <Footer />
      ...
      <SectionContact />
      <div className="absolute backdrop-blur-[22px] bg-[rgba(255,255,255,0.85)] content-stretch flex items-center justify-between left-[calc(28.57%+195.43px)] pl-[18px] pr-[12px] py-[10px] rounded-[64px] top-[24px] w-[524px]" data-name="Sticky Header">
